package com.finelite.blog.web.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.finelite.blog.entity.constant.RespCodeConstants;
import com.finelite.blog.entity.response.BaseResponse;
...
public class AuthTokenFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public AuthTokenFilter(RequestMatcher matcher){super(matcher);};
    ...
    public Authentication attemptAuthentication(HttpServletRequest httpServletRequest,
        ...
        {
            authToken = httpServletRequest.getParameter(this.tokenName);
        }
        logger.info("start to check token:"+ authToken +" *************");
        if (authToken == null)
        {
                                              ...
                                              AuthenticationException authException) throws IOException, ServletException
    {
        ...
        baseResponse.setStatusCode(RespCodeConstants.RESPONSE_STATUS_CODE_FAILED);
