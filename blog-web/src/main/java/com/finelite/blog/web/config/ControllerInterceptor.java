package com.finelite.blog.web.config;
...
public class ControllerInterceptor
{
  ...
  @Pointcut("execution(* com.finelite.blog.web.controller..*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
